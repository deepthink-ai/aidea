mixin AppLocale {
  ...
  static const Map<String, dynamic> zh = {
    ...
    aIdeaApp: 'DeepThink是一款能够让你与 AI 对话的应用，应用代码完全开源。',
  ...
  static const Map<String, dynamic> en = {
    ...
    aIdeaApp: 'DeepThink is an app that allows you to converse with AI, and the app code is completely open source.',
